...
from hkex_agent.cli.config import COLORS, COMMANDS, HKEX_AGENT_ASCII, MAX_ARG_LENGTH, console
from hkex_agent.cli.file_ops import FileOperationRecord
...
def show_help():
    ...
    console.print("  hkex help                                Show this help message")
    console.print()

    console.print("[bold]Examples:[/bold]", style=COLORS["primary"])
    console.print(
        "  hkex                              # Start with default agent", style=COLORS["dim"]
    )
    console.print(
        "  hkex --agent mybot                # Start with agent named 'mybot'",
        style=COLORS["dim"],
    )
    console.print(
    ...
    console.print(
        "  hkex list                         # List all agents", style=COLORS["dim"]
    )
    console.print(
        "  hkex reset --agent mybot          # Reset mybot to default", style=COLORS["dim"]
    )
    console.print(
        "  hkex reset --agent mybot --target other # Reset mybot to copy of 'other' agent",
        style=COLORS["dim"],
    )
    console.print()
    ...
    console.print("[bold]HKEX Agent Features:[/bold]", style=COLORS["primary"])
    console.print("  - Search HKEX announcements by stock code and date range", style=COLORS["dim"])
    console.print("  - Download and analyze PDF announcements", style=COLORS["dim"])
    console.print("  - Intelligent PDF caching (no re-downloads)", style=COLORS["dim"])
    console.print("  - Generate structured reports from announcement data", style=COLORS["dim"])
    console.print()

    console.print("[bold]Agent Storage:[/bold]", style=COLORS["primary"])
    console.print("  Agents are stored in: ~/.hkex-agent/AGENT_NAME/", style=COLORS["dim"])
