...
from src.cli.config import COLORS, console
...
def _list() -> None:
    ...
    skills_dir = Path.home() / ".hkex-agent" / "agent" / "skills"

    if not skills_dir.exists() or not any(skills_dir.iterdir()):
        console.print("[yellow]No skills found.[/yellow]")
        console.print(
            "[dim]Skills will be created in ~/.hkex-agent/agent/skills/ when you add them.[/dim]",
            style=COLORS["dim"],
        )
        console.print(
    ...
    for skill in skills:
        ...
        console.print(
            f"    Location: ~/.hkex-agent/agent/skills/{skill_dir_name}/", style=COLORS["dim"]
        )
        console.print()
...
"""
    ...
    console.print(
        ...
        "\n"
        "   Copy an example: cp -r examples/skills/web-research ~/.hkex-agent/agent/skills/\n",
        style=COLORS["dim"],
    )
