...
def _is_safe_path(path: Path, base_dir: Path) -> bool:
    ...
    Example:
        >>> base = Path("/home/user/.hkex-agent/skills")
        >>> safe = Path("/home/user/.hkex-agent/skills/web-research/SKILL.md")
        >>> unsafe = Path("/home/user/.hkex-agent/skills/../../.ssh/id_rsa")
...
def list_skills(skills_dir: Path) -> list[SkillMetadata]:
    ...
    Example:
        ...
        skills_dir = Path.home() / ".hkex-agent" / "skills"
